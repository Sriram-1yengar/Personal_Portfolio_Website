...
summary: An optical comfort photo utility that detects elevated red tones and rough skin texture to provide subtle, edge-preserving portrait corrections with 100% in-browser privacy.
year: 2025
...
featured: true
order: 1
tags: ['Computer Vision', 'Image Processing', 'Accessibility', 'React', 'Frontend']
